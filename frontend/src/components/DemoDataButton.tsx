...
/**
 * DemoDataButton - Generates sample applications for exploration.
 * @param props - Optional callback and extra class names.
 * @returns The demo data button and confirmation dialog.
 */
  ...
  return (
    <>
      <Button
        ...
        variant="primary"
        className={`w-full sm:w-auto shadow-md shadow-primary-500/20 ${className}`}
      >
      ...
      {showConfirm && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4 animate-fade-in">
          <div className="bg-bg-surface rounded-2xl shadow-2xl max-w-md w-full p-6 animate-slide-up border border-border">
            <div className="text-center">
              <div className="w-16 h-16 bg-primary-100 dark:bg-primary-900/30 rounded-full flex items-center justify-center mx-auto mb-4">
                <Icon name="add" size={32} className="text-primary-600" />
              </div>

              <h3 className="text-xl font-semibold text-text-primary mb-2">Generate Demo Data</h3>
              ...
              <div className="text-xs text-text-muted mb-6 p-3 bg-bg-subtle border border-border rounded-lg text-left">
